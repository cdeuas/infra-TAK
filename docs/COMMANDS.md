...
python3 - <<'PY'
import re, sys
tag = "v0.6.3-alpha"  # change each release
want = tag.lstrip("v")
...
PY
git commit -m "v0.6.3-alpha"
git push origin main
git tag v0.6.3-alpha && git push origin v0.6.3-alpha
git checkout dev
```
