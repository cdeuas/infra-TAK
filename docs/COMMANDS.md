...
git checkout dev -- \
  ...
  README.md \
  docs/COMMANDS.md \
  docs/RELEASE-v0.8.7-alpha.md \
  docs/RELEASE-v0.8.6-alpha.md \
...
python3 - <<'PY'
import re, sys
tag = "v0.8.7-alpha"  # change each release
want = tag.lstrip("v")
...
PY
git commit -m "v0.8.7-alpha"
git push origin main
git tag v0.8.7-alpha && git push origin v0.8.7-alpha
git checkout dev
```
